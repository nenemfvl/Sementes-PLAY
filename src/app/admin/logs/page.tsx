  ...
  const carregarLogs = async () => {
    try {
      ...
      setLogs([
        {
          id: '1',
          timestamp: new Date('2024-01-20 18:30:00'),
          nivel: 'info',
          categoria: 'usuario',
          acao: 'LOGIN',
        ...
        {
          id: '2',
          timestamp: new Date('2024-01-20 18:25:00'),
          nivel: 'success',
          categoria: 'admin',
          acao: 'APROVAR_CANDIDATURA',
          descricao: 'Admin aprovou candidatura de criador',
          usuario: {
            id: 'admin1',
        ...
        {
          id: '3',
          timestamp: new Date('2024-01-20 18:20:00'),
          nivel: 'warning',
          categoria: 'sistema',
        ...
        {
          id: '4',
          timestamp: new Date('2024-01-20 18:15:00'),
          nivel: 'error',
          categoria: 'financeiro',
          acao: 'ERRO_PROCESSAMENTO_PAGAMENTO',
          descricao: 'Erro ao processar pagamento de saque',
          usuario: {
            id: '2',
            nome: 'Maria Santos',
        ...
        {
          id: '5',
          timestamp: new Date('2024-01-20 18:10:00'),
          nivel: 'info',
          categoria: 'seguranca',
          acao: 'ALTERACAO_SENHA',
          descricao: 'Usuário alterou senha da conta',
          usuario: {
            id: '3',
            nome: 'Pedro Costa',
        ...
        {
          id: '6',
          timestamp: new Date('2024-01-20 18:05:00'),
          nivel: 'success',
          categoria: 'sistema',
          acao: 'BACKUP_DATABASE',
          ...
          detalhes: {
            ...
            duracao: '15 minutos',
            tipo: 'completo',
            destino: 's3://backups-sementesplay'
          }
        }
      ])
    } catch (error) {
