...
// Função para calcular pontuação de um criador (baseado apenas em sementes)
export function calcularPontuacaoCriador(criador: any): number {
  ...
  // Pontuação total composta (apenas sementes + pontos do usuário)
  return sementesRecebidas + pontosUsuario
}
