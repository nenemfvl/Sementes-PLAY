        ...
        <div className="p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center">
              ...
              <h3 className="text-lg font-semibold text-white">Denunciar Conteúdo</h3>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="bg-gray-700 rounded-lg p-4 mb-6">
            ...
            <p className="text-white font-medium">{tituloConteudo}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {tiposDenuncia.map((tipoOption) => (
                  <label key={tipoOption.valor} className="flex items-start space-x-3 cursor-pointer">
                    ...
                    <div className="flex-1">
                      <p className="text-white font-medium">{tipoOption.label}</p>
            ...
            <div>
              ...
              <textarea
                ...
                rows={4}
                className="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2 text-white focus:border-blue-500 focus:outline-none resize-none"
              />
            </div>
