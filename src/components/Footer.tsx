    ...
    <footer className="bg-black border-t border-gray-700 mt-16">
      <div className="max-w-4xl mx-auto px-4 py-10 flex flex-col items-center">
        ...
        <div className="flex gap-4 mb-4">
          <a href="https://discord.gg/7vtVZYvR" title="Discord" className="text-gray-400 hover:text-sementes-accent" target="_blank" rel="noopener noreferrer">
          ...
          <a href="https://www.instagram.com/sementesplay/" title="Instagram" className="text-gray-400 hover:text-sementes-accent" target="_blank" rel="noopener noreferrer">
            <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://www.youtube.com/@SementesPLAY" title="YouTube" className="text-gray-400 hover:text-sementes-accent" target="_blank" rel="noopener noreferrer">
            <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://x.com/SementesPLAY" title="Twitter" className="text-gray-400 hover:text-sementes-accent" target="_blank" rel="noopener noreferrer">
            <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-4 text-gray-400 text-sm">
          <Link href="/termos" className="hover:text-sementes-accent">Termos de Uso</Link>
          <span>|</span>
          <Link href="/privacidade" className="hover:text-sementes-accent">Política de Privacidade</Link>
          <span>|</span>
          <Link href="/ajuda" className="hover:text-sementes-accent">Ajuda</Link>
        </div>
