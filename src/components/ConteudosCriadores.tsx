    ...
    const fetchConteudos = async () => {
      try {
        ...
        const mockConteudos: Conteudo[] = [
          {
            id: '1',
            titulo: 'Review do Novo Produto Tech',
            descricao: 'Análise completa do mais recente lançamento da indústria',
            data: '2024-01-20',
          ...
          },
          {
            ...
            descricao: 'Aprenda a fazer o melhor bolo de chocolate',
            data: '2024-01-19',
            url: 'https://instagram.com/p/ABC123',
            tipo: 'imagem',
            preview: 'https://via.placeholder.com/400x300/FF6B6B/FFFFFF?text=Culinária',
          ...
          {
            id: '3',
            titulo: 'Live de Gaming',
            descricao: 'Stream ao vivo jogando o novo lançamento',
            data: '2024-01-18',
            url: 'https://twitch.tv/streamer123',
            tipo: 'video',
            preview: 'https://via.placeholder.com/400x300/9146FF/FFFFFF?text=Gaming',
            criador: { nome: 'Pedro Costa' },
            categoria: 'Gaming',
            visualizacoes: 2300,
            curtidas: 234,
          ...
          {
            id: '4',
            titulo: 'Dicas de Fitness',
            descricao: 'Rotina de exercícios para iniciantes',
            data: '2024-01-17',
            url: 'https://tiktok.com/@fitness123',
            tipo: 'video',
            preview: 'https://via.placeholder.com/400x300/25F4EE/FFFFFF?text=Fitness',
            criador: { nome: 'Ana Oliveira' },
            categoria: 'Fitness',
            visualizacoes: 1200,
            curtidas: 178,
          ...
          },
          {
            ...
            descricao: 'Estratégias para crescer nas redes sociais',
            data: '2024-01-16',
            url: 'https://medium.com/@marketer123',
            tipo: 'link',
            preview: 'https://via.placeholder.com/400x300/00AB6B/FFFFFF?text=Marketing',
            criador: { nome: 'Carlos Ferreira' },
            categoria: 'Marketing',
            visualizacoes: 650,
            curtidas: 45,
            compartilhamentos: 8
